<script>
    ...
    export let skills = [{name: "skill1", icon: "nf-mdi-music_note"}, {name: "skill2", icon: "nf-mdi-music_note"}];
    export let description = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl aliquet nisl, eget aliquam nisl nisl sit amet lorem. Donec auctor, nisl eget aliquam luctus, nunc nisl al";
...
<div class="root">
    ...
    <h2>{#each skills as {icon, name} }
            <div class="skillItem"><i class="nf {icon}"></i> <p class="tooltip">{name}</p></div>
    {/each}</h2>

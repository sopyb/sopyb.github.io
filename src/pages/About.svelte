...
<Panel bgcolor="var(--color-bg-primary)">
    <InfoBoard>
        ...
        <InfoCard class="infoCard" color="var(--abtme-item2)" slot="item2">
        ...
        <InfoCard class="infoCard" color="var(--abtme-item3)" slot="item3">
        ...
        <InfoCard class="infoCard" color="var(--abtme-item5)" slot="item5">
        ...
        <InfoCard class="infoCard" color="var(--abtme-item6)" slot="item6">
        ...
        <InfoCard class="infoCard" color="var(--abtme-item9)" slot="item9">
